...
*scene4-06|
[eval exp="f.chaptertitle='Continued Tentacle Rape with Yume'"]

;場所：触手で満たされた学園内の教室。
;時間：不明
;服装：ボロボロになった水着。

;ＣＧ１３(ev404)：触手に犯され続ける

;ＢＧＭ：陵辱１
[playbgm storage="bgm009"]

[SoundIn storage="se122" buf=7 loop=true time=2000]
[SoundIn storage="se167" buf=8 loop=true time=2000]

;イベント絵表示
[CgSet storage="EV404a"]
[UpDate time=1000]
...
[eval exp="sf.kaisouOpenFlag['09']=1"]
